            ...
            <div class="container-fluid">
                <form method='POST' action="{{ route('historique') }}" enctype="multipart/form-data">
                    ...
                    <select class="form-select form-select-lg mb-3" style="width:300px;"name="feuille">
                        <option value="Redressement financier">Redressement financier</option>
                        <option value="Redressement technique">Redressement technique</option>
                        <option value="Redressement commercial">Redressement commercial</option>
                        <option value="Projets bailleurs">Projets bailleurs</option>
                    </select>
                </form>
